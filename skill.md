...
6. **Informar al conserje del mensaje enviado al residente (TRANSPARENCIA):**
   ...
   ```
   Si el residente no tiene canal registrado, este paso no aplica (ya se
   avisó al conserje en el paso 2).
...
4. Broadcast a comunidad (si está configurado): "Llegó un paquete sin identificación clara. ¿Es suyo?"
...
> AIC → residente 502: "� María, llegó tu pedido de Uber Eats! Baja pronto 🔥"
> AIC → conserje: "📢 Le envié esto al depto 502:
> '� María, llegó tu pedido de Uber Eats! Baja pronto 🔥'"

> Residente 502 responde: "ya bajo en 10"
> AIC → residente 502: "👍 Perfecto, acá lo esperamos."
...
- Si el canal del residente no está disponible y el AIC ya avisó que no puede notificarlo.
